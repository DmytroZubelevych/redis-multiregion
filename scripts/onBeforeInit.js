...
if (regions.array.length < 3) {
  fields["count"].markup = "Package cannot be installed on less than 3 regions. Please contact support or choose a <a href='https://jelastic.cloud/?regions=multiregion' target='_blank'>provider</a> with more regions";
